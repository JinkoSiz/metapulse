...
class Settings(BaseSettings):
    ...
    # Потолок времени на резюме за один обход. Локальная модель тратит минуты на игру,
    # и без ограничения обход из 20 игр не уложился бы в часовой слот. Собранные игры
    # видны на витрине сразу, а резюме догоняются следующими заходами: input_hash не даёт
    # пересчитывать уже готовое. 0 — без ограничения.
    llm_budget_seconds: int = 1800
